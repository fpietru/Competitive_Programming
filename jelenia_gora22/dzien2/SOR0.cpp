...
//               nazwa          liczba            rozsz     całość
vector<pair<pair<string, pair<int, string>>, pair<string, string>>> v;

/*
	1) Porównywana jest sama nazwa
		2) Porównywane są liczby
		
	Jeśli i nazwa i liczba jest taka sama:
		3) Porównywane rozszerzenie
			4) Porównywana całość
*/
